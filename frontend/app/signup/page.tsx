        ...
        <Card className="shadow-xl border-0">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <Link href={`${API_BASE_URL}/oauth2/authorization/google`} className="block w-full" passHref>
              ...
              <Link href={`${API_BASE_URL}/oauth2/authorization/naver`} className="block w-full" passHref>
                <Button variant="outline" className="w-full h-12 border-gray-200 hover:bg-gray-50 bg-transparent">
                  <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24">
